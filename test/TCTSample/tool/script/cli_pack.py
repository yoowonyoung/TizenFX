...
def pack(module , cnt):  
    ...
    TPK_PATH = PROJECT_PATH+PACKAGE_NAME+'/bin/Debug/tizen40/'+PACKAGE_NAME+'-1.0.0.tpk'
    ...
    # create zip 
    zip('bin', RELEASE_PATH+PACKAGE_NAME+'-4.0')
    if os.path.isfile(RELEASE_PATH+PACKAGE_NAME+'-4.0.zip'):
    ...
    shutil.copy(RELEASE_PATH+PACKAGE_NAME+'-4.0.zip', '../../release/'+TCT+'/'+TCT+'/package/mobile/')

    # If TCT is installed , replace package
    if os.path.isdir('/opt/tct/tizen_csharp_4.0'):
        shutil.copy(RELEASE_PATH+PACKAGE_NAME+'-4.0.zip', '/opt/tct/tizen_csharp_4.0/packages/mobile')
...
if __name__ == "__main__":
    ...
    if os.path.isdir('/opt/tct/tizen_csharp_4.0'):
        shutil.copy('../../release/'+TCT+'/'+TCT+'/package/pkg_infos/mobile_pkg_info.xml', '/opt/tct/tizen_csharp_4.0/packages/pkg_infos')
