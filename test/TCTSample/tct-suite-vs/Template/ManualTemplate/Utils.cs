...
namespace NUnit.Framework
{
    ...
    public class ManualTest
    {
        ...
        public static async Task WaitForConfirm()
        {
            ...
            if (IsWearable())
            {
                await WearableTemplate.ManualTest.WaitForConfirm();
            }
            else
            {
                _messageFail = "";
        ...
        public static bool IsConfirmed()
        {
            if (IsWearable())
            {
                return WearableTemplate.ManualTest.IsConfirmed();

            }
            else
            {
                LogUtils.Write(LogUtils.DEBUG, LogUtils.TAG, "[Common] IsConfirmed()");
        ...
        public static void Confirm()
        {
            if (IsWearable())
            {
                WearableTemplate.ManualTest.Confirm();
            }
            else
            {
        ...
        public static void DisplayCustomLabel(String msg)
        {
            if (IsWearable())
            {
                WearableTemplate.ManualTest.DisplayCustomLabel(msg);
            }
            else
            {
                var _testPage = TestPage.GetInstance();
